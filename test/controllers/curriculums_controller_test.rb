...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference("Curriculum.count") do
      post curriculums_url, params: { curriculum: { class_type: @curriculum.class_type, current: @curriculum.current, name: @curriculum.name, organization_id: @curriculum.organization_id, start_date: @curriculum.start_date } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { class_type: @curriculum.class_type, current: @curriculum.current, name: @curriculum.name, organization_id: @curriculum.organization_id, start_date: @curriculum.start_date } }
