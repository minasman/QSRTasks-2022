...
class MocsTest < ApplicationSystemTestCase
  ...
  test "should create moc" do
    ...
    fill_in "Cleansuccess", with: @moc.cleansuccess
    fill_in "Cleantotal", with: @moc.cleantotal
    ...
    fill_in "Dt cars actual 1", with: @moc.dt_cars_actual_1
    fill_in "Dt cars actual 2", with: @moc.dt_cars_actual_2
    fill_in "Dt cars actual 3", with: @moc.dt_cars_actual_3
    fill_in "Dt cars target 1", with: @moc.dt_cars_target_1
    fill_in "Dt cars target 2", with: @moc.dt_cars_target_2
    fill_in "Dt cars target 3", with: @moc.dt_cars_target_3
    ...
    fill_in "Grillsuccess", with: @moc.grillsuccess
    fill_in "Moc date", with: @moc.moc_date
    fill_in "Moc time", with: @moc.moc_time
    fill_in "More practice comments", with: @moc.more_practice_comments
    ...
    fill_in "Servicesuccess", with: @moc.servicesuccess
    fill_in "Servicetotal", with: @moc.servicetotal
    fill_in "Signature", with: @moc.signature
    fill_in "Store", with: @moc.store_id
    check "Verified" if @moc.verified
    fill_in "Very good comments", with: @moc.very_good_comments
    click_on "Create Moc"
