...
class CurriculumsTest < ApplicationSystemTestCase
  ...
  test "should create curriculum" do
    ...
    fill_in "Class type", with: @curriculum.class_type
    check "Current" if @curriculum.current
    fill_in "Name", with: @curriculum.name
    fill_in "Organization", with: @curriculum.organization_id
    fill_in "Start date", with: @curriculum.start_date
