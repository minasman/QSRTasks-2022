...
ActiveRecord::Schema[7.0].define(version: 2022_08_14_184114) do
  ...
  create_table "mocs", force: :cascade do |t|
    ...
    t.boolean "verified"
    t.string "dt_target_1"
    t.string "dt_target_2"
    t.string "dt_target_3"
    t.string "dt_actual_1"
    t.string "dt_actual_2"
    t.string "dt_actual_3"
    ...
    t.string "add_target_4"
    t.string "add_target_5"
    t.string "add_target_6"
    t.string "add_actual_1"
    t.string "add_actual_2"
    t.string "add_actual_3"
    t.string "add_actual_4"
    t.string "add_actual_5"
    t.string "add_actual_6"
    t.string "q1"
    t.string "q2"
    t.string "q3"
    t.string "q4"
    ...
    t.string "cleanlinessTotal"
    t.string "veryGoodComments"
    t.string "morePracticeComments"
    t.string "preshiftSuccess"
    t.string "duringShiftSuccess"
    t.string "postShiftSuccess"
    t.string "slSignature"
    t.string "coachSignature"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
